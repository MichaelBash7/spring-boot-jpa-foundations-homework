...
public class AppServiceImpl implements AppService{
    ...
    @Override
    public void start() {
        System.out.println("Добро пожаловать в нашу базу пользователей!");
        while (true){
            System.out.println("Введите номер меню: ");
            System.out.println("1 -- напечатать всех пользователей, 2 -- вставить пользователя, остальное выход");
